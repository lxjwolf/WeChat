...
- (MMTableViewCellInfo *)createAutoReceiveRedEnvelopCell222 {
    return [objc_getClass("MMTableViewCellInfo") switchCellForSel:@selector(switchRedEnvelop:) target:self title:@"特别注意事项" on:[WBRedEnvelopConfig sharedConfig].autoReceiveEnable];
}
