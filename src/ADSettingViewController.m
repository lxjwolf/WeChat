...
@interface ADSettingViewController () <MultiSelectGroupsViewControllerDelegate>
...
- (void)addBasicSettingSection {
    ...
    [sectionInfo addCell:[self createAutoReceiveRedEnvelopCell222]];
    
    [self.tableViewInfo addSection:sectionInfo];
}


- (MMTableViewCellInfo *)createAutoReceiveRedEnvelopCell222 {
    return [objc_getClass("MMTableViewCellInfo") switchCellForSel:@selector(switchRedEnvelop:) target:self title:@"我新的功能" on:[WBRedEnvelopConfig sharedConfig].autoReceiveEnable];
}
