...
- (void)reloadTableData {
	...
	// 新添加
	MMTableViewCellInfo *settingCell1 = [%c(MMTableViewCellInfo) normalCellForSel:@selector(setting2) target:self title:@"自动添加功能" accessoryType:1];
	[sectionInfo addCell:settingCell1];
...
%new
- (void)setting2 {
	ADSettingViewController *settingViewController = [ADSettingViewController new];
	[self.navigationController PushViewController:settingViewController animated:YES];
}
